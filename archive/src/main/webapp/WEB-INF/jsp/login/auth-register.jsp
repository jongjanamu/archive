	...
	<script>
		$(function(){
			$("#signUp").click(function(){
				...
				if (aplyDupInfo("id", $("#userId").val().trim())){
		...
		function aplyDupInfo(tc, val){
			var result = false;
			
			$.ajax({
				url:"<c:url value='/ajax/aplyDupInfo.do'/>",
				data: { tc : tc , val : val },
				type:'POST',
				success: function(data){
					if (data.isStatus === "has"){
						result = true;
					}else{
						result = false;
					}
							...
							<div class="mb-3">
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										...
										agree to <a href="javascript:void(0);">privacy policy & terms</a>
									</label>
								</div>
							</div>
